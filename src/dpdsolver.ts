...
function getencodedstring(majors : string): string{
    var encodeddpd = ""
    switch(majors){ //m was replaced by l for indexing to work
        case "000": encodeddpd = "bcdfgh0jkl";
            break;
        case "001": encodeddpd = "bcdfgh100l";
            break;
        case "010": encodeddpd = "bcdjkh101l";
            break;
        case "011": encodeddpd = "bcd10h111l";
            break;
        case "100": encodeddpd = "jkdfgh110l";
            break;
        case "101": encodeddpd = "fgd01h111l";
            break;
        case "110": encodeddpd = "jkd00h111l";
            break;
        case "111": encodeddpd = "00d11h111l";
            break;
    }
    return encodeddpd;
}
...
function getdpd(encodeddpd : string, three_digit_num : string): string{
    ...
    for(let i = 0; i<three_digit_num.length; i++){
        tempdigit = ""
        let digit = new Decimal(three_digit_num[i]);
